...
import { KenaikanPangkatFungsional } from "@/data/kenaikan-pangkat-fungsional";
...
export default function KenaikanPangkatFungsionalPage({
  files = KenaikanPangkatFungsional,
