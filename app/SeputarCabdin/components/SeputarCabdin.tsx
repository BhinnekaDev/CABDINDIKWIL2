...
import { useSeputarCabdinList } from "@/hooks/useSeputarCabdin";

export default function SeputarCabdinPage() {
  const { data: berita, loading } = useSeputarCabdinList();
  return (
    <div className="relative py-6">
      ...
      <div className="relative z-10">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-extrabold mb-4">Seputar CABDIN</h1>
          <p className="max-w-2xl mx-auto text-gray-700">
            Temukan berbagai informasi terbaru, kegiatan, dan berita seputar
            Cabang Dinas Pendidikan Wilayah II. Tetap terhubung dengan
            perkembangan dunia pendidikan di wilayah kami.
          </p>
        </div>
